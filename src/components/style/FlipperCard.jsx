    ...
    return (
        <motion.div onMouseOver={() => {
            ...
            >
                ...
                <div className={'z-0 absolute w-full h-full rounded-xl ' +(mouseOver ? 'outline-12 bg-radial from-lime-300 to-lime-300/0 outline-lime-400/50 outline-double animate-pulsing' : '')} />
            </div>
        </motion.div>
    )
}
